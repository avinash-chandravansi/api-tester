...
$(document).ready(() => {
  $("#show").click(() => {
    $("#extra-outer").css("display", "block");
    $("#output-outer").css("display", "none");
    $("#instructions").css("display", "none");
  });
  $("#button").click(() => {
    $("#instructions").css("display", "none");
    $("#extra-outer").css("display", "none");
    $("#output-outer").css("display", "block");
    ...
    if (document.getElementById("hp1").value) {
      ...
      if (document.getElementById("hp2").value) {
        ...
        if (document.getElementById("hp3").value) {
          ...
          if (document.getElementById("hp4").value) {
            document.getElementById("url").value =
              document.getElementById("url").value +
              "&" +
              document.getElementById("hp4").value +
              "=" +
              document.getElementById("vp4").value;

            if (document.getElementById("hp5").value) {
              document.getElementById("url").value =
                document.getElementById("url").value +
                "&" +
                document.getElementById("hp5").value +
                "=" +
                document.getElementById("vp5").value;

              if (document.getElementById("hp6").value) {
                document.getElementById("url").value =
                  document.getElementById("url").value +
                  "&" +
                  document.getElementById("hp6").value +
                  "=" +
                  document.getElementById("vp6").value;

                if (document.getElementById("hp7").value) {
                  document.getElementById("url").value =
                    document.getElementById("url").value +
                    "&" +
                    document.getElementById("hp7").value +
                    "=" +
          ...
          if (document.getElementById("h4").value) {
            ...
            if (document.getElementById("h5").value) {
              ...
              if (document.getElementById("h6").value) {
                ...
                if (document.getElementById("h7").value) {
                  req.setRequestHeader(
    ...
    if (document.getElementById("request-body").value) {
      // alert(document.getElementById("request-body").value);
      // var data = document.getElementById("request-body").value;
      ...
      req.send(JSON.parse(JSON.stringify(data)));
    } else {
      req.send();
    }
    var status = req.status;
    var statusprint = status + " " + req.statusText;
    // document.getElementById("res-h").innerHTML = req.status + req.statusText;
    if (status == 100) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br>This interim response indicates that everything so far is OK and that the client should continue the request, or ignore the response if the request is already finished."
      );
      $(".grid-item").css(
        "box-shadow",
        "0 2px 4px 0 yellow, 0 3px 10px 0 yellow"
      );
      $(".grid-item").css("color", "yellow");
    }
    if (status == 101) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br>This code is sent in response to an Upgrade request header from the client, and indicates the protocol the server is switching to."
      );
      $(".grid-item").css(
        "box-shadow",
        "0 2px 4px 0 yellow, 0 3px 10px 0 yellow"
    ...
    if (status == 102) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br>This code indicates that the server has received and is processing the request, but no response is available yet"
      );
      $(".grid-item").css(
        "box-shadow",
        "0 2px 4px 0 yellow, 0 3px 10px 0 yellow"
    ...
    if (status == 103) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br> This status code is primarily intended to be used with the Link header, letting the user agent start preloading resources while the server prepares a response."
      );
      $(".grid-item").css(
        "box-shadow",
        "0 2px 4px 0 yellow, 0 3px 10px 0 yellow"
    ...
    if (status == 200) {
      $("#res-h").html(
        "<h3>" + statusprint + "</h3>" + " <br> The request has succeeded"
      );
      $(".grid-item").css(
        "box-shadow",
        "0 2px 4px 0 green, 0 3px 10px 0 green"
      );
      $(".grid-item").css("color", "green");
    }
    if (status == 201) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br>The request has succeeded and a new resource has been created as a result. This is typically the response sent after POST requests, or some PUT requests."
      );
      $(".grid-item").css(
        "box-shadow",
        "0 2px 4px 0 green, 0 3px 10px 0 green"
    ...
    if (status == 202) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br>The request has been received but not yet acted upon. It is noncommittal, since there is no way in HTTP to later send an asynchronous response indicating the outcome of the request. It is intended for cases where another process or server handles the request, or for batch processing."
      );
      $(".grid-item").css(
        "box-shadow",
        "0 2px 4px 0 green, 0 3px 10px 0 green"
    ...
    if (status == 204) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br> There is no content to send for this request, but the headers may be useful. The user-agent may update its cached headers for this resource with the new ones."
      );
      $(".grid-item").css(
        "box-shadow",
        "0 2px 4px 0 green, 0 3px 10px 0 green"
    ...
    if (status == 205) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br>     Tells the user-agent to reset the document which sent this request."
      );
      $(".grid-item").css(
        "box-shadow",
        "0 2px 4px 0 green, 0 3px 10px 0 green"
    ...
    if (status == 206) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br>This response code is used when the Range header is sent from the client to request only part of a resource. "
      );
      $(".grid-item").css(
        "box-shadow",
        "0 2px 4px 0 green, 0 3px 10px 0 green"
    ...
    if (status >= 300 && status <= 308) {
      $("#res-h").html(
        "<h3>" + statusprint + "</h3>" + " <br> Redirection messages.   "
      );
      $(".grid-item").css(
        "box-shadow",
        "0 2px 4px 0 yellow, 0 3px 10px 0 yellow"
    ...
    if (status == 400) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br>  The server could not understand the request due to invalid syntax. "
      );
      $(".grid-item").css("box-shadow", "0 2px 4px 0 red, 0 3px 10px 0 red");
      $(".grid-item").css("color", "red");
    }
    if (status == 401) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br>     Although the HTTP standard specifies unauthorized, semantically this response means unauthenticated. That is, the client must authenticate itself to get the requested response.   "
      );
      $(".grid-item").css("box-shadow", "0 2px 4px 0 red, 0 3px 10px 0 red");
      $(".grid-item").css("color", "red");
    }
    if (status == 402) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br>This response code is reserved for future use. The initial aim for creating this code was using it for digital payment systems, however this status code is used very rarely and no standard convention exists. "
      );
      $(".grid-item").css("box-shadow", "0 2px 4px 0 red, 0 3px 10px 0 red");
      $(".grid-item").css("color", "red");
    }
    if (status == 403) {
      $("#res-h").html(
        "<h3>" +
          statusprint +
          "</h3>" +
          " <br> The client does not have access rights to the content; that is, it is unauthorized, so the server is refusing to give the requested resource. Unlike 401, the client's identity is known to the server."
      );
      $(".grid-item").css("box-shadow", "0 2px 4px 0 red, 0 3px 10px 0 red");
      $(".grid-item").css("color", "red");
    }
    ...
    if (status == 405) {
      $("#res-h").html(
        "<h3>" +
          ...
          "</h3>" +
          "</h3>" +
          " <br> The request method is known by the server but has been disabled and cannot be used. For example, an API may forbid DELETE-ing a resource. The two mandatory methods, GET and HEAD, must never be disabled and should not return this error code. "
      );
      $(".grid-item").css("box-shadow", "0 2px 4px 0 red, 0 3px 10px 0 red");
      $(".grid-item").css("color", "red");
    }
    if (status == 406) {
      $("#res-h").html(
        "<h3>" +
          ...
          "</h3>" +
          "</h3>" +
          " <br>  This response is sent when the web server, after performing server-driven content negotiation, doesn't find any content that conforms to the criteria given by the user agent."
      );
      $(".grid-item").css("box-shadow", "0 2px 4px 0 red, 0 3px 10px 0 red");
      $(".grid-item").css("color", "red");
    }
    if (status == 408) {
      ...
      if (status >= 100 && status <= 150) {
        $(".grid-item").css(
          "box-shadow",
          "0 2px 4px 0 blue, 0 3px 10px 0 blue"
        );
        $(".grid-item").css("color", "blue");
      }
    ...
    var headers = req.getAllResponseHeaders().toString();
    document.getElementById("header").innerHTML = headers;
    $("#repo").html(req.response);
    $(".ip").css("color", "black");
  });
});
